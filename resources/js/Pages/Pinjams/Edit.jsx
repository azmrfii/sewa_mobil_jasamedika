...
export default function PinjamMobil({ auth }) {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        patch(route("pinjams.update", pinjam.id));
    }
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Tanggal Pinjam</h2>}
        >
            <Head title="Edit Tanggal Pinjam" />
